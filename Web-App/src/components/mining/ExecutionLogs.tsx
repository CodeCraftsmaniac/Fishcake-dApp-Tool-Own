      ...
      <CardContent className="p-6">
        ...
        {filteredLogs.length === 0 ? (
          <div className="text-center py-12">
            ...
            <h4 className="font-medium mb-2">No Logs Yet</h4>
            <p className="text-sm text-muted-foreground">
...
function LogEntry({ 
  ...
  return (
    <div className={`flex items-start gap-3 p-3 rounded-lg ${config.bg} border border-transparent hover:border-border transition-colors`}>
      ...
      <div className="flex-1 min-w-0">
        ...
        {log.txHash && (
          <a
            ...
            className="text-xs text-fishcake-400 hover:underline font-mono mt-1 block"
          >
